...
%
% Downloaded from: https://se.mathworks.com/matlabcentral/fileexchange/37105-plot-spread-points-beeswarm-plot
%
%
            ...
            switch opt.xyOri
                case 'normal'
                    ph(iData,iCategory) = plot(ah,data(currentIdx,1),...
                        ...
                        'lineStyle','none',...
                        'DisplayName',plotLabels{iData,iCategory},'MarkerSize',50);
                case 'flipped'
